...
data class ReviewItems(
    @field:Json(name = "review") val reviews: List<Review>,
) {
    @JsonClass(generateAdapter = true)
    data class Review(
        @field:Json(name = "name") val name: String,
        @field:Json(name = "designation") val designation: String,
        @field:Json(name = "relation") val relation: String,
        @field:Json(name = "review") val review: String,
        @field:Json(name = "relationDetails") val relationDetails: String,
    )
            ...
            ReviewItems(
                listOf(
                    Review(
                        ...
                        review =
                            "Salam is an exceptional talent in the world of Android development, for now, and pretty sure he will make big impact with other technologies. He has made a significant impact during the time we worked together and I’m hoping our paths will cross and enjoy working on a project.\n" +
                                "\n" +
